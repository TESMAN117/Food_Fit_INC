...
public class Ctrl_Corte extends Celdas implements ActionListener {
    ...
    public void Abreformulario_Corte() {
        ...
        Image img = Toolkit.getDefaultToolkit().getImage("src\\Multimedia\\Botones\\Corte de caja.png");
    ...
    public void imagen() {
        ImageIcon icon = new ImageIcon("src\\Multimedia\\Botones\\_cortecosto.png");
        this.form.lbl_IMG.setText(null);
        this.form.lbl_IMG.setSize(181, 144);
        Icon icono = new ImageIcon(icon.getImage().getScaledInstance(form.lbl_IMG.getWidth(), form.lbl_IMG.getHeight(),
                Image.SCALE_DEFAULT));
        this.form.lbl_IMG.setIcon(icono);
    ...
    public void Dideña_Boton() {
        ...
        this.form.btn_Corte.setBorder(borde);
        this.form.btn_Realizar.setBorder(borde);
        this.form.btn_Salir.setBorder(borde);
