...
public class Frm_Catalogo_Persona extends Frame_Interno  {
    ...
    private void initComponents() {
        ...
        Tbl_Persona.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellidos", "Email", "Telefono", "RFC", "Sucursal", "Codigo Postal", "Domicilio"
            }
        ) {
        ...
        if (Tbl_Persona.getColumnModel().getColumnCount() > 0) {
            Tbl_Persona.getColumnModel().getColumn(0).setPreferredWidth(10);
        }
